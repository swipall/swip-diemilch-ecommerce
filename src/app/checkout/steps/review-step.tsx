            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        {order.shipment_address ? (
                            <div className="text-sm space-y-3">
                                <div>
                                    ...
                                    <p className="text-white/50">{order.shipment_address.address}</p>
                                    {order.shipment_address.suburb && (
                                        <p className="text-white/50">{order.shipment_address.suburb}</p>
                                    )}
                                    <p className="text-white/50">
                                        {order.shipment_address.city}, {order.shipment_address.state} {order.shipment_address.postal_code}
                                    </p>
                                    <p className="text-white/50">{order.shipment_address.country}</p>
                                    {order.shipment_address.mobile && (
                                        <p className="text-white/50">{order.shipment_address.mobile}</p>
                                    )}
                                </div>
                                <Button
                                    variant="outline"
                            ...
                            <p className="text-sm text-white/50">No hay dirección de envío configurada</p>
                        )}
                    </div>
                )}
                        ...
                        <div>
                            {isForDelivery && deliveryItem ? (
                                ...
                                <>
                                    ...
                                    <p className="text-white/50">Sin costo</p>
                                </>
                            ) : (
                                <p className="text-white/50">No hay método de entrega seleccionado</p>
                            )}
                        </div>
                        <Button
                            variant="outline"
                ...
                <div className="space-y-3">
                    ...
                    {selectedPaymentMethod ? (
                        ...
                        <p className="text-sm text-white/50">No hay método de pago seleccionado</p>
                    )}
                </div>
            </div>
