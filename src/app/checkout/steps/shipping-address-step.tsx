                                ...
                                <Label htmlFor={address.id} className="flex-1 cursor-pointer">
                                    <Card className="p-4">
                                        <div className="leading-tight space-y-0">
                                            ...
                                            <p className="text-sm text-white/50">{address.country}</p>
                                            {address.mobile && <p className="text-sm text-white/50">{address.mobile}</p>}
                                            {address.references && <p className="text-sm text-white/50">Referencias: {address.references}</p>}
                                        </div>
                                    </Card>
                                </Label>
                            </div>
